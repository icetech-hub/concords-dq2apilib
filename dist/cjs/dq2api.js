...
exports.newAPI = exports.isConnected = void 0;
const _dq2wasmapilib_module = __importStar(require("../dq2apilib.js"));
...
const newAPI = async () => {
    ...
    return {
        Connect: async (identity, company, product, addr, name, password, autoreconnect, interval, missed) => {
            ...
            while (!(0, exports.isConnected)(id) && connectionWaitCount < 50) {
        ...
        OnConnectStatusFunc: async (callback) => {
            ...
            callback((0, exports.isConnected)(id) ? 1 : 0);
            return Promise.resolve();
        },
